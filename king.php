...
<?php
 ...
 ?>
<div class="para">
    <p> <h3> The King is the most important chess piece on the board.  <br>
If you lose the king, you lose the game so be very careful about exposing or attacking with him.  <br>
It can move and attack one square in any direction, but it cannot make a move that would allow another piece to take itself in the next turn. </h3> </p>
