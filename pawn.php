...
<?php
 ...
 ?>
 <div class = "para">
<h3> It can either move one or two squares. Each subsequent move can only be one tile upwards.
A pawn can never move backwards.<br>
Its attack is simple: one square in either diagonal direction. Give it a try!</h3> 
