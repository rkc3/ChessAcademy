...
<div class= "para">
    <p> <h3> The Knight is a very special piece. <br>
It moves to a square that is two squares away horizontally and one square vertically, or two squares vertically and one square horizontally, all of which make an L pattern. <br>
The knight can attack pieces at the end of the 'L'. It is also the only chess piece that is allowed to move over its own pieces. Give it a try!</h3> </p>
</div> 
